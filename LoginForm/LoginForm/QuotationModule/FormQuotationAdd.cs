...
namespace LoginForm.QuotationModule
{
    public partial class FormQuotationAdd : MyForm
    {
        ...
        {
            if (dgQuotationAddedItems.RowCount > 1) dgQuotationAddedItems.Rows[dgQuotationAddedItems.RowCount - 1].Cells[dgNo.Index].Value = (Decimal.Parse(dgQuotationAddedItems.Rows[dgQuotationAddedItems.RowCount - 2].Cells[dgNo.Index].Value.ToString()) + 1).ToString();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (SaveOK)
            {
                ...
                {
                    MessageBox.Show("Delete line please");
                }
            }
        ...
        private void dgQuotationAddedItems_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                //ItemClear();
                //try { ItemDetailsFiller(dgQuotationAddedItems.Rows[dgQuotationAddedItems.SelectedRows.Count - 1].Cells[dgProductCode.Index].Value.ToString()); } catch { }
            }
            else if (e.KeyCode == Keys.Down)
            {
                //ItemClear();
                //try { ItemDetailsFiller(dgQuotationAddedItems.Rows[dgQuotationAddedItems.SelectedRows. + 1].Cells[dgProductCode.Index].Value.ToString()); } catch { }
            }
        }
