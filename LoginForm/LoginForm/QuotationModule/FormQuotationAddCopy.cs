...
{
    public partial class FormQuotationAddCopy : Form
    {
        #region Definitions
        ...
        public FormQuotationAddCopy(Quotation quotation)
        {
...
, Int32.Parse(sp1.Col1Break.ToString()))).ToString("G29");
        ...
        private void ProductCodeEndEdit()
        {
            #region PRODUCT CODE
