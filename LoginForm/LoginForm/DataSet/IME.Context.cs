...
namespace LoginForm.DataSet
{
    ...
    public partial class IMEEntities : DbContext
    {
        ...
        public virtual int MonthlySalaryVoucherDetailsViewAll(string strMonth, string month, string monthYear, Nullable<decimal> isEditMode, string voucherNo)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("MonthlySalaryVoucherDetailsViewAll", strMonthParameter, monthParameter, monthYearParameter, isEditModeParameter, voucherNoParameter);
        }
