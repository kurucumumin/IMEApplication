...
namespace LoginForm
{
    ...
    public partial class frmBillallocation : Form
    {
        ...
        public void DefaultLoadFun()
        {
            ...
            try
            {
                dtpfromdate.Value = db.CurrentDate().FirstOrDefault().Value;
                dtpfromdate.MinDate = m.FinancialYear.fromDate.Value;
                dtpfromdate.MaxDate = m.FinancialYear.toDate.Value;
                dtpfromdate.CustomFormat = "dd-MMMM-yyyy";
                dtptodate.Value = db.CurrentDate().FirstOrDefault().Value;
                dtptodate.MinDate = m.FinancialYear.fromDate.Value;
                dtptodate.MaxDate = m.FinancialYear.toDate.Value;
        ...
        public void clear()
        {
            ...
            try
            {
                ...
                txtfromdate.Text = db.CurrentDate().FirstOrDefault().Value.ToString("dd-MMM-yyyy");
                txttodate.Text = db.CurrentDate().FirstOrDefault().Value.ToString("dd-MMM-yyyy");
        ...
        private void txtfromdate_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtfromdate.Text = new IMEEntities().CurrentDate().FirstOrDefault().Value.ToString("dd-MMM-yyyy");
                }
        ...
        private void txttodate_Leave(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txttodate.Text = new IMEEntities().CurrentDate().FirstOrDefault().Value.ToString("dd-MMM-yyyy");
                }
                ...
                if (e.RowIndex != -1)
                {
                    ...
                    if (strTypeOfVoucher == "PDC Payable")
                    {
                        ...
                        if (frmpdcPayableObj == null)
                        {
                            ...
                            frmpdcPayableObj.MdiParent = FormMain.MDIObj;
                    ...
                    if (strTypeOfVoucher == "PDC Receivable")
                    {
                        ...
                        if (frmPdcReceivableObj == null)
                        {
                            ...
                            frmPdcReceivableObj.MdiParent = FormMain.MDIObj;
                    ...
                    if (strTypeOfVoucher == "Payment Voucher")
                    {
                        ...
                        if (frmPaymentVoucherObj == null)
                        {
                            ...
                            frmPaymentVoucherObj.MdiParent = FormMain.MDIObj;
                    ...
                    if (strTypeOfVoucher == "Receipt Voucher")
                    {
                        ...
                        if (frmReceiptVoucherObj == null)
                        {
                            ...
                            frmReceiptVoucherObj.MdiParent = FormMain.MDIObj;
                    ...
                    if (strTypeOfVoucher == "Journal Voucher")
                    {
                        ...
                        if (frmJournalVoucherObj == null)
                        {
                            ...
                            frmJournalVoucherObj.MdiParent = FormMain.MDIObj;
                    ...
                    if (strTypeOfVoucher == "Credit Note")
                    {
                        ...
                        if (frmCreditNoteObj == null)
                        {
                            ...
                            frmCreditNoteObj.MdiParent = FormMain.MDIObj;
                    ...
                    if (strTypeOfVoucher == "Debit Note")
                    {
                        ...
                        if (frmDebitNoteObj == null)
                        {
                            ...
                            frmDebitNoteObj.MdiParent = FormMain.MDIObj;
