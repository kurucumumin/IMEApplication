...
namespace LoginForm
{
    public partial class frmReceiptVoucher : Form
    {
        ...
        public void Delete(decimal decMasterId)
        {
            try
            {
                if (!new PartyBalanceSP().PartyBalanceCheckReference(decReceiptVoucherTypeId, strVoucherNo))
                {
                    new ReceiptMasterSP().ReceiptVoucherDelete(decRecieptmasterId, decReceiptVoucherTypeId, strVoucherNo);
        ...
        public void Save()
        {
            ...
            try
            {
                ...
                InfoReceiptMaster.financialYearId = m.CurrentFinancialYear;
                ...
                InfoReceiptMaster.userId = Utils.getCurrentUser().WorkerID;
                if (!isAutomatic)
                {
        ...
        public void Edit(decimal decMasterId)
        {
            ...
            try
            {
                ...
                InfoReceiptMaster.financialYearId = Utils.getManagement().CurrentFinancialYear;
                InfoReceiptMaster.ledgerId = Convert.ToDecimal(cmbCashOrBank.SelectedValue.ToString());
        ...
        public void PrintForDotMatrix(decimal decReceiptMasterId)
        {
            try
            {
                ...
                dRowOther["AmountInWords"] = new NumToText().AmountWords(Convert.ToDecimal(txtTotal.Text), (decimal)Utils.getManagement().DefaultCurrency);
                VoucherTypeSP spVoucherType = new VoucherTypeSP();
        ...
        public void FillFunction()
        {
            try
            {
                ...
                dtpDate.Value = Convert.ToDateTime(InfoReceiptMaster.date);
                ...
                decDailySuffixPrefixId = Convert.ToDecimal(InfoReceiptMaster.suffixPrefixId);
                decReceiptVoucherTypeId = Convert.ToDecimal(InfoReceiptMaster.voucherTypeId);
