...
namespace LoginForm
{
    public partial class frmPurchaseReturn : Form
    {
        ...
        PurchaseReturnMaster infoPurchaseReturnMaster = new PurchaseReturnMaster();
        #endregion
        ...
        private void FillProductDetails(string strProductCode, int rowIndex)
        {
            try
            {
                ...
                if (Convert.ToInt32(infoProductFill.ProductId) != 0)
                {
                    ...
                    string decProdtId = infoProductFill.ProductId;
        ...
        //            dgvPurchaseReturn.Rows[inI].Cells["dgvtxtrate"].Value = Math.Round(infoProduct.PurchaseRate, 4);
        ...
        private void CalculateTotalAmount()
        {
            try
            {
                lblTaxAmount.Visible = true;
                {
                    ...
                    txtTotalAmount.Text = (decTotal >= 0) ? Math.Round(decTotal, 4).ToString() : Math.Round(0.00,4).ToString();
                }
            }
            catch (Exception ex)
            {
                ...
                if (txtBillDiscount.Text != string.Empty)
                {
                    if (txtTotalAmount.Text != string.Empty)
                    {
                        ...
                        if (decTotalAmount >= decBillDiscount)
                        {
                            ...
                            txtGrandTotal.Text = (decGrandTotal >= 0) ? Math.Round(decGrandTotal, 4).ToString() : Math.Round(0.00, 4).ToString();
                        }
                        else
                        {
                            txtBillDiscount.Text = "0.00";
        ...
        public void AmountCalculation(string columnName, int inIndexOfRow)
        {
            try
            {
                ...
                if (dgrow.Cells["dgvtxtrate"].Value != null && dgrow.Cells["dgvtxtrate"].Value.ToString() != string.Empty)
                {
                    ...
                    dgrow.Cells["dgvtxtgrossValue"].Value = Math.Round(decdgvtxtgrossValue, 4);
                }
                if (dgrow.Cells["dgvtxtgrossValue"].Value != null && dgrow.Cells["dgvtxtgrossValue"].Value.ToString() != string.Empty)
                {
                    ...
                    if (dgrow.Cells["dgvtxtdiscount"].Value != null && dgrow.Cells["dgvtxtdiscount"].Value.ToString() != string.Empty)
                    {
                        ...
                        {
                            decNetAmount = Math.Round((decdgvtxtgrossValue - decDiscountCalc), 4);
                            dgrow.Cells["dgvtxtNetAmount"].Value = Math.Round(decNetAmount, 4);
                        }
                        else
                        {
                    ...
                    if (dgrow.Cells["dgvtxtproductId"].Value != null && dgrow.Cells["dgvtxtproductId"].Value.ToString() != string.Empty)
                    {
                        if (dgrow.Cells["dgvcmbTax"].Value != null && dgrow.Cells["dgvcmbTax"].Value.ToString() != string.Empty && dgrow.Cells["dgvcmbTax"].Value.ToString() != "NA")
                        {
                            ...
                            if (decTaxPercent != 0)
                            {
                                ...
                                decTotalAmnt = Math.Round((decNetAmount + decTaxAmt), 4);
                                dgrow.Cells["dgvtxttaxAmount"].Value = Math.Round(decTaxAmt, 4);
                                decTaxAmt = Convert.ToDecimal(dgrow.Cells["dgvtxttaxAmount"].Value.ToString());
                                dgrow.Cells["dgvtxtAmount"].Value = Math.Round(decTotalAmnt, 4);
                            }
                            else
                            {
                                dgrow.Cells["dgvtxttaxAmount"].Value = "0";
                                dgrow.Cells["dgvtxtAmount"].Value = Math.Round(decNetAmount, 4);
                            }
                        }
                        else
                        {
                ...
                if (dgvPurchaseReturn.Rows[inIndexOfRow].Cells["dgvtxtproductId"].Value != null)
                {
                                   ...
                                   dgvPurchaseReturn.CurrentRow.Cells["dgvtxtproductId"].Value.ToString() != "0")
                    {
                        ...
                        if (dgvPurchaseReturn.CurrentRow.Cells["dgvtxtrate"].Value != null && dgvPurchaseReturn.CurrentRow.Cells["dgvtxtrate"].Value.ToString() != string.Empty)
                        {
                            ...
                            dgvPurchaseReturn.CurrentRow.Cells["dgvtxtrate"].Value = Math.Round(decProductRate, 4);
                        }
                    }
                }
            }
            ...
            try
            {
                if (!isEditFill)
                {
                    ...
                    foreach (DataRow drowDetails in dtblDetails.Rows)
                    {
                        ...
                        decQty = Math.Round(Convert.ToDecimal(Convert.ToString(drowDetails.ItemArray[10])), 4);
                        ...
                        decRate = Math.Round(Convert.ToDecimal(Convert.ToString(drowDetails.ItemArray[11])), 4);
                        ...
                        dgvPurchaseReturn.Rows[dgvPurchaseReturn.Rows.Count - 2].Cells["dgvtxtgrossValue"].Value = Math.Round(decGrossAmount, 4);
                        ...
                        if (Convert.ToString(drowDetails.ItemArray[7]) != string.Empty)
                        {
                            ...
                            decDiscountAmount = Math.Round(Convert.ToDecimal(Convert.ToString(drowDetails.ItemArray[7])), 4);
                        }
                        else
                        {
                            decDiscountAmount = 0;
                        ...
                        dgvPurchaseReturn.Rows[dgvPurchaseReturn.Rows.Count - 2].Cells["dgvtxtNetAmount"].Value = (decNetAmount != 0) ? Math.Round(decNetAmount, 4) : 0;
                        if (strTaxComboFill != string.Empty)
                        {
                            ...
                            if (strTaxRate1 != string.Empty)
                            {
                                ...
                                dgvPurchaseReturn.Rows[dgvPurchaseReturn.Rows.Count - 2].Cells["dgvtxttaxAmount"].Value = Math.Round(decTaxAmount, 4);
                            }
                            else
                            {
                        ...
                        dgvPurchaseReturn.Rows[dgvPurchaseReturn.Rows.Count - 2].Cells["dgvtxtAmount"].Value = Math.Round(decAmount, 4);
        ...
        public void SaveOrEdit()
        {
            try
            {
                ...
                PurchaseReturnDetail infoPurchaseReturnDetails = new PurchaseReturnDetail();
                ...
                PurchaseReturnBilltax infoPurchaseReturnBillTax = new PurchaseReturnBilltax();
                ...
                infoPurchaseReturnMaster.exchangeRateId = Convert.ToInt32((cmbCurrency.SelectedValue != null) ? Convert.ToDecimal(cmbCurrency.SelectedValue.ToString()) : 0);
                infoPurchaseReturnMaster.narration = txtNarration.Text.Trim();
                infoPurchaseReturnMaster.userId = Utils.getCurrentUser().WorkerID;
                ...
                infoPurchaseReturnMaster.financialYearId = Utils.getManagement().CurrentFinancialYear;
                ...
                else
                {
                    ...
                    decExchangeRate = spExchangeRate.ExchangeRateViewByExchangeRateId(Convert.ToInt32(infoPurchaseReturnMaster.exchangeRateId));
                    SPPurchaseReturnMaster.PurchaseReturnMasterEdit(infoPurchaseReturnMaster);
                    infoPurchaseMaster = SPPurchaseMaster.PurchaseMasterView((decimal)infoPurchaseReturnMaster.purchaseMasterId);
                ...
                if (btnSave.Text == "Update")
                {
                    ...
                    {
                        spStockPosting.StockPostingDeleteByagainstVoucherTypeIdAndagainstVoucherNoAndVoucherNoAndVoucherType(0, "NA", infoPurchaseReturnMaster.voucherNo, (decimal)infoPurchaseReturnMaster.voucherTypeId);
                    }
                    if (infoPurchaseReturnMaster.purchaseMasterId != 0)
                    {
                        infoPurchaseMaster = SPPurchaseMaster.PurchaseMasterView((decimal)infoPurchaseReturnMaster.purchaseMasterId);
                        spStockPosting.StockPostingDeleteByagainstVoucherTypeIdAndagainstVoucherNoAndVoucherNoAndVoucherType((decimal)infoPurchaseMaster.voucherTypeId, strInvoiceNo, strVoucherNo, (decimal)infoPurchaseReturnMaster.voucherTypeId);
                    }
                }
                ...
                foreach (DataGridViewRow dgvrow in dgvPurchaseReturn.Rows)
                {
                    if (dgvrow.Cells["dgvtxtProductId"].Value != null && dgvrow.Cells["dgvtxtProductId"].Value.ToString() != string.Empty)
                    {
                        ...
                        {
                            infoPurchaseReturnDetails.taxId = Convert.ToInt32(Convert.ToString(dgvrow.Cells["dgvcmbTax"].Value));
                            if (strTaxComboFill != string.Empty)
                            {
                        ...
                        infoPurchaseReturnDetails.purchaseDetailsId = Convert.ToInt32((dgvrow.Cells["dgvtxtPurchaseDetailsId"].Value != null) ? Convert.ToDecimal(Convert.ToString(dgvrow.Cells["dgvtxtPurchaseDetailsId"].Value)) : 0);
                        ...
                        decimal decConversionId = SPUnitConversion.UnitConversionRateByUnitConversionId((decimal)infoPurchaseReturnDetails.unitConversionId);
                        ...
                        if (infoPurchaseReturnDetails.purchaseDetailsId != 0)
                        {
                            ...
                            decAgainstVoucherTypeId = (decimal)infoStockPosting.voucherTypeId;
                        }
                        else
                        {
                ...
                infoAccountLedger = spAccountLedger.AccountLedgerView((decimal)infoPurchaseReturnMaster.ledgerId);
                ...
                foreach (DataGridViewRow item in dgvPurchaseReturnTax.Rows)
                {
                    if (item.Cells["dgvtxtTaxId"].Value != null)
                    {
                        ...
                        infoPurchaseReturnBillTax.taxId = Convert.ToInt32(item.Cells["dgvtxtTaxId"].Value.ToString());
        ...
        public void Delete()
        {
            try
            {
                ...
                {
                    infoPurchaseMaster = SPPurchaseMaster.PurchaseMasterView((decimal)infoPurchaseReturnMaster.purchaseMasterId);
                    spStockPosting.StockPostingDeleteByagainstVoucherTypeIdAndagainstVoucherNoAndVoucherNoAndVoucherType((decimal)infoPurchaseMaster.voucherTypeId, infoPurchaseMaster.voucherNo, strVoucherNo, (decimal)infoPurchaseReturnMaster.voucherTypeId);
                }
        ...
        public void FillRegisterOrReport()
        {
            try
            {
                ...
                if (dtblPurchaseReturnMaster.Rows.Count > 0)
                {
                    ...
                    decimal decDiscnt = Math.Round(Convert.ToDecimal(dtblPurchaseReturnMaster.Rows[0]["discount"].ToString()), 4);
                    ...
                    for (int i = 0; i < dtbl.Rows.Count; i++)
                    {
                        ...
                        dgvPurchaseReturn.Rows[i].Cells["dgvtxtrate"].Value = Math.Round(decRate, 4);
                        decimal decGross = Convert.ToDecimal(dtbl.Rows[i]["grossAmount"].ToString());
                        dgvPurchaseReturn.Rows[i].Cells["dgvtxtgrossValue"].Value = Math.Round(decGross, 4);
                        decimal decDis = Convert.ToDecimal(dtbl.Rows[i]["discount"].ToString());
                        dgvPurchaseReturn.Rows[i].Cells["dgvtxtdiscount"].Value = Math.Round(decDis, 4);
                        decimal decNet = Convert.ToDecimal(dtbl.Rows[i]["netAmount"].ToString());
                        dgvPurchaseReturn.Rows[i].Cells["dgvtxtNetAmount"].Value = Math.Round(decNet, 4);
                        decimal decTax = Convert.ToDecimal(dtbl.Rows[i]["taxAmount"].ToString());
                        dgvPurchaseReturn.Rows[i].Cells["dgvtxttaxAmount"].Value = Math.Round(decTax, 4);
                        decimal decTotal = Convert.ToDecimal(dtbl.Rows[i]["amount"].ToString());
                        dgvPurchaseReturn.Rows[i].Cells["dgvtxtAmount"].Value = Math.Round(decTotal, 4);
                    ...
                    if (dgvRow.Cells["dgvtxtTaxId"].Value != null)
                    {
                        if (dgvRow.Cells["dgvtxtTaxApplicableOn"].Value != null && dgvRow.Cells["dgvtxtCalculatingMode"].Value != null)
                        {
                            if (dgvRow.Cells["dgvtxtTaxApplicableOn"].Value.ToString() == "Bill" && dgvRow.Cells["dgvtxtCalculatingMode"].Value.ToString() == "Bill Amount")
                            {
                                ...
                                dgvRow.Cells["dgvtxtAmounts"].Value = Math.Round(decTaxOnBill, 4);
                            ...
                            foreach (DataGridViewRow dgvRow2 in dgvPurchaseReturnTax.Rows)
                            {
                                foreach (DataRow drow in dtbl.Rows)
                                {
                                    if (dgvRow2.Cells["dgvtxtTaxId"].Value != null && dgvRow2.Cells["dgvtxtTaxId"].Value.ToString() == drow.ItemArray[0].ToString())
                                    {
                                        ...
                                        dgvRow1.Cells["dgvtxtAmounts"].Value = Math.Round(decTaxOnTax, 4);
            ...
            try
            {
                foreach (DataGridViewRow dgvTaxRow in dgvPurchaseReturnTax.Rows)
                {
                    if (dgvTaxRow.Cells["dgvtxtTaxId"].Value != null && dgvTaxRow.Cells["dgvtxtTaxId"].Value.ToString() != string.Empty && dgvTaxRow.Cells["dgvtxtTaxId"].Value.ToString() != "0")
                    {
                        ...
                        dgvTaxRow.Cells["dgvtxtAmounts"].Value = Math.Round(decDefaultAmount, 4);
                        decAmount = 0;
                    }
                }
            }
                            ...
                            if (dgvPurchaseReturn.Rows[e.RowIndex].Cells["dgvtxtPurchaseDetailsId"].Value != null)
                            {
                                if (Convert.ToDecimal(dgvPurchaseReturn.Rows[e.RowIndex].Cells["dgvtxtPurchaseDetailsId"].Value.ToString()) > 0)
                                {
                                    if (dgvPurchaseReturn.Rows[e.RowIndex].Cells["dgvtxtqty"].Value != null)
                                    {
                                        ...
                                        {
                                            dgvPurchaseReturn.Rows[e.RowIndex].Cells["dgvtxtqty"].Value = Math.Round(Convert.ToDecimal(dtbl.Rows[e.RowIndex]["qty"].ToString()), 4);
                                        }
                                    }
                                }
                            }
