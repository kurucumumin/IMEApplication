...
namespace LoginForm
{
    public partial class frmSalesReturn : Form
    {
        ...
        //TODO: Sales Return Register Formu eklenecek.
        //frmSalesReturnRegister objFromSalesReturnRegister = null;
        SalesMasterSP spSalesMaster = new SalesMasterSP();
        SalesReturnMaster infoSalesReturnMaster = new SalesReturnMaster();
       ...
       // frmVoucherWiseProductSearch objVoucherWiseSearch = null;
                ...
                if (dgvSalesReturn.Rows[inIndexOfRow].Cells["productId"].Value != null)
                {
                    ...
                    foreach (DataRow drUnitByProduct in dtblUnitByProduct.Rows)
                    {
                        if (dgvSalesReturn.Rows[inIndexOfRow].Cells["dgvCmbUnit"].Value.ToString() == drUnitByProduct.ItemArray[0].ToString())
                        {
                            ...
                            dgvSalesReturn.Rows[inIndexOfRow].Cells["dgvTextRate"].Value = Math.Round(decNewRate);
                        }
                    }
                }
            }
        ...
        public void ReturnFromProductCreation(decimal decProductId)
        {
            ...
            try
            {
                ...
                if (decProductId != 0)
                {
                    ...
                    infoProduct = spProduct.ProductView(decProductId.ToString());
            ...
            try
            {
                ...
                if (inRowCount > 1)
                {
                    for (int i = 0; i < inRowCount - 1; i++)
                    {
                        ...
                        {
                            decProductId =dgvSalesReturn.Rows[i].Cells["productId"].Value.ToString();
                        ...
                        foreach (DataGridViewRow dgvrItem in dgvSalesReturn2.Rows)
                        {
                            if (dgvrItem.Cells["dgvTextTaxId"].Value != null)
                            {
                                if (dgvrItem.Cells["dgvTextTaxId"].Value.ToString() == drowItem["taxId"].ToString())
                                {
                                    ...
                                    {
                                        dgvrItem.Cells["dgvTextAmount"].Value = Math.Round((Convert.ToDecimal(drowItem["rate"].ToString()) * Convert.ToDecimal(txtTotalAmount.Text)) / 100);
                                        decTotalBillTaxAmount = Math.Round(Convert.ToDecimal(dgvrItem.Cells["dgvTextAmount"].Value.ToString()));
                                    }
                                }
                            }
                        }
                ...
                if (dtblSalesReturnMaster.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow drowDetails in dtblSalesReturnDetails.Rows)
                    {
                        ...
                        if (drowDetails["productId"].ToString() != string.Empty)
                        {
                            ...
                            foreach (DataRow drowDetails1 in dtbl.Rows)
                            {
                                ...
                                {
                                    decProductId = dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["productId"].Value.ToString();
                                ...
                                {
                                    BatchComboFill(Convert.ToDecimal(decProductId), dgvSalesReturn.Rows.Count - 2, dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvCmbBatch"].ColumnIndex);
                                ...
                                {
                                    dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvTextQty"].Value = Math.Round(Convert.ToDecimal(drowDetails["qty"].ToString()));
                                    decQty = Math.Round(Convert.ToDecimal(drowDetails["qty"].ToString()));
                                }
                                else
                                {
                                ...
                                {
                                    dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvTextRate"].Value = Math.Round(Convert.ToDecimal(drowDetails["rate"].ToString()));
                                ...
                                if (drowDetails["grossAmount"].ToString() != string.Empty)
                                {
                                    ...
                                    dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvTextGrossValue"].Value = Math.Round(Convert.ToDecimal(drowDetails["grossAmount"].ToString()), 4);
                                ...
                                if (drowDetails["discount"].ToString() != string.Empty)
                                {
                                    ...
                                    dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvTextDiscountAmount"].Value = Math.Round(Convert.ToDecimal(drowDetails["discount"].ToString()),4);
                                }
                                else
                                {
                                ...
                                if (drowDetails["netAmount"].ToString() != string.Empty)
                                {
                                    ...
                                    dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvTextNetValue"].Value = Math.Round(Convert.ToDecimal(drowDetails["netAmount"].ToString()), 4);
                                ...
                                if (drowDetails["taxAmount"].ToString() != string.Empty)
                                {
                                    ...
                                    dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvTextTaxAmount"].Value = Math.Round(Convert.ToDecimal(drowDetails["taxAmount"].ToString()),4);
                                ...
                                {
                                    dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvTextAmount1"].Value = Math.Round(Convert.ToDecimal(drowDetails["amount"].ToString()), 4);
                    ...
                    if (!isSalesReturnFormActive)
                    {
                        ...
                        foreach (DataRow item1 in dtblTaxGride.Rows)
                        {
                            ...
                            dgvSalesReturn2.Rows[dgvSalesReturn2.Rows.Count - 2].Cells["dgvTextAmount"].Value = Math.Round(Convert.ToDecimal(item1["taxAmount"].ToString()), 4);
                    ...
                    txtBillDiscount.Text = Convert.ToString(Math.Round(Convert.ToDecimal(dtblSalesReturnMaster.Rows[0]["discount"].ToString()), 4));
                    SerialNo2();
                    ...
                    if (txtBillDiscount.Text != string.Empty)
                    {
                        ...
                        if (decTotalAmt > decDiscount)
                        {
                            ...
                            decGrandTotal = Math.Round(decGrandTotal, 4);
        ...
        public void PrintForDotMatrix(decimal decSalesReturnMasterId)//used by safiyy
        {
            try
            {
                ...
                dRowOther["AmountInWords"] = new NumToText().AmountWords(Convert.ToDecimal(txtGrandTotal.Text), 4);
                VoucherTypeSP spVoucherType = new VoucherTypeSP();
        ...
        public void Save()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        infoSalesReturnMaster.userId = Convert.ToInt32(cmbSalesMan.SelectedValue.ToString());
                    }
                    else
                    {
                        infoSalesReturnMaster.userId = 0;
                    }
                    if (cmbCurrency.SelectedValue != null)
                    {
                        infoSalesReturnMaster.exchangeRateId = Convert.ToInt32(cmbCurrency.SelectedValue.ToString());
                        decExchangeRate = spExchangeRate.ExchangeRateViewByExchangeRateId(Convert.ToDecimal(infoSalesReturnMaster.exchangeRateId));
                    }
                    infoSalesReturnMaster.narration = txtNarration.Text.Trim();
                    infoSalesReturnMaster.userId = Utils.getCurrentUser().WorkerID;
                    ...
                    infoSalesReturnMaster.financialYearId = Utils.getManagement().FinancialYear.financialYearId;
                    if (txtBillDiscount.Text != string.Empty)
                    {
                    ...
                    SalesReturnDetail infoSalesReturnDetailsInfo = new SalesReturnDetail();
                    if (btnSave.Text == "Update")
                    {
                    ...
                    foreach (DataGridViewRow DGVSalesReturn in dgvSalesReturn.Rows)
                    {
                        if (DGVSalesReturn.Cells["productId"].Value != null && DGVSalesReturn.Cells["productId"].Value.ToString() != string.Empty)
                        {
                            ...
                            {
                                infoSalesReturnDetailsInfo.salesDetailsId = Convert.ToInt32(DGVSalesReturn.Cells["salesDetailsId"].Value.ToString());
                            }
                            else
                            {
                            ...
                            if (DGVSalesReturn.Cells["voucherTypeId"].Value != null)
                            {
                                ...
                                decAgainstVoucherTypeId = Convert.ToDecimal(infoStockPosting.voucherTypeId);
                            ...
                            if (infoSalesReturnDetailsInfo.productId != 0 && infoSalesReturnDetailsInfo.unitId != 0)
                            {
                                ...
                                DataTable dtbl = spUnitConvertion.DGVUnitConvertionRateByUnitId(Convert.ToDecimal(infoSalesReturnDetailsInfo.unitId), infoProduct.ProductName);
                            ...
                            infoStockPosting.financialYearId = Utils.getManagement().FinancialYear.financialYearId;
                    ...
                    SalesReturnBillTax infoSalesReturnBillTax = new SalesReturnBillTax();
                ...
                foreach (DataGridViewRow dgvrow in dgvSalesReturn2.Rows)
                {
                    if (dgvrow.Cells["dgvTextAmount"].Value != null)
                    {
                        if (dgvrow.Cells["dgvTextAmount"].Value.ToString() != string.Empty)
                        {
                            ...
                            decTotal = Math.Round(decTotal, 4);
                            ...
                            foreach (DataRow drowDetails in dtblSalesReturnGrideFill.Rows)
                            {
                                ...
                                if (drowDetails["productId"].ToString() != string.Empty)
                                {
                                    ...
                                    foreach (DataRow drowDetails1 in dtbl.Rows)
                                    {
                                        ...
                                        if (drowDetails["qty"].ToString() != string.Empty)
                                        {
                                            dgvSalesReturn.Rows[dgvSalesReturn.Rows.Count - 2].Cells["dgvTextQty"].Value = Math.Round(Convert.ToDecimal(drowDetails["qty"].ToString()), 4);
                                            decQty = Math.Round(Convert.ToDecimal(drowDetails["qty"].ToString()), 4);
                                        }
                                        else
                                        {
                ...
                if (dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextGrossValue"].Value != null)
                {
                    if (dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextGrossValue"].Value.ToString() != string.Empty)
                    {
                        ...
                        if (inColumnIndex == dgvSalesReturn.Columns["dgvTextDiscountPercentage"].Index)
                        {
                            ...
                            {
                                dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextDiscountAmount"].Value = Math.Round(decDiscountAmount, 4);
                            }
                        }
                        else if (inColumnIndex == dgvSalesReturn.Columns["dgvTextDiscountAmount"].Index)
                        {
                            ...
                            {
                                dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextDiscountAmount"].Value = Math.Round(decDiscountPercent, 4);
                            }
                        }
                    }
                }
                ...
                if (dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextGrossValue"].Value != null)
                {
                    if (dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextGrossValue"].Value.ToString() != string.Empty)
                    {
                        ...
                        else if (inColumnIndex == dgvSalesReturn.Columns["dgvTextDiscountAmount"].Index)
                        {
                            ...
                            if (decDiscountPercent > 0)
                            {
                                dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextDiscountPercentage"].Value = Math.Round(decDiscountPercent, 4);
                            }
                        }
                    }
                }
                ...
                if (dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextQty"].Value.ToString() != string.Empty && dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextQty"].Value.ToString() != null)
                {
                    ...
                    if (dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextRate"].Value != null || dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextRate"].Value.ToString() != string.Empty)
                    {
                        ...
                        if (decrate >= 0)
                        {
                            ...
                            dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextGrossValue"].Value = Math.Round((dcGrossValue), 4);
                        }
                    }
                }
            }
        ...
        public void BatchComboFill(decimal decProductId, int inRow, int inColumn)
        {
            try
            {
                ...
                dtbl = spBatch.BatchNamesCorrespondingToProduct(Convert.ToString(decProductId));
                            ...
                            if (item["selectedTaxId"].ToString() != String.Empty)
                            {
                                foreach (DataGridViewRow drowDetails1 in dgvSalesReturn2.Rows)
                                {
                                    if (drowDetails1.Cells["dgvTextTaxId"].Value != null)
                                    {
                                        ...
                                        {
                                            drowDetails.Cells["dgvTextAmount"].Value = Math.Round((Convert.ToDecimal(drowDetails1.Cells["dgvTextAmount"].Value.ToString()) * Convert.ToDecimal(drowDetails.Cells["dgvRate"].Value.ToString())) / 100, 4);
                                            decCessamount = Convert.ToDecimal(drowDetails.Cells["dgvTextAmount"].Value.ToString());
                                            decTotalCessTaxamount = Math.Round(decTotalCessTaxamount + decCessamount, 4);
        ...
        public void ProductDetailsFill(string strProduct, int inRowIndex, string strFillMode)
        {
            try
            {
                ...
                if (dtbl.Rows.Count != 0)
                {
                    ...
                    //  SerialNo();
                    dgvSalesReturn.Rows[inRowIndex].Cells["productId"].Value = dtbl.Rows[0]["Article_No"];
                    string decProductId = dtbl.Rows[0]["Article_No"].ToString();
                    //dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextBarcode"].Value = dtbl.Rows[0]["barcode"];
                    dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextProductCode"].Value = dtbl.Rows[0]["Article_No"];
                    dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextProductName"].Value = dtbl.Rows[0]["Article_Desc"];
                    ...
                    ////if (dtbl.Rows[0]["unitConversionId"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["unitConversionId"].Value = dtbl.Rows[0]["unitConversionId"];
                    ...
                    //if (dtbl.Rows[0]["dgvCmbRack"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["dgvCmbRack"].Value = Convert.ToDecimal(dtbl.Rows[0]["rackId"].ToString());
                    //BatchComboFill(Convert.ToDecimal(decProductId), inRowIndex, dgvSalesReturn.Rows[inRowIndex].Cells["dgvCmbBatch"].ColumnIndex);
                    //if (dtbl.Rows[0]["batchId"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["dgvCmbBatch"].Value = Convert.ToDecimal(dtbl.Rows[0]["batchId"].ToString());
                    //decimal decBatchId = Convert.ToDecimal(dgvSalesReturn.Rows[inRowIndex].Cells["dgvCmbBatch"].Value.ToString());
                    //if (dtbl.Rows[0]["salesRate"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextRate"].Value = Math.Round(Convert.ToDecimal(dtbl.Rows[0]["salesRate"].ToString()), 4);
                    getProductRate(inRowIndex, decProductId);
                    TaxGridFill();
                    if (dtbl.Rows[0]["taxId"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["dgvCmbTax"].Value = Convert.ToDecimal(dtbl.Rows[0]["taxId"].ToString());
                    if (dtbl.Rows[0]["conversionRate"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["conversionRate"].Value = dtbl.Rows[0]["conversionRate"];
                    if (dtbl.Rows[0]["discountPercent"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextDiscountPercentage"].Value = dtbl.Rows[0]["discountPercent"].ToString();
                    if (dtbl.Rows[0]["cdiscount"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextDiscountAmount"].Value = Math.Round(Convert.ToDecimal(dtbl.Rows[0]["discount"]), 4);
                     dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextDiscountAmount"].ReadOnly = true;
                    if (dtbl.Rows[0]["netvalue"] != null) dgvSalesReturn.Rows[inRowIndex].Cells["dgvTextNetValue"].Value = Math.Round(Convert.ToDecimal(dtbl.Rows[0]["netvalue"]), 4);
                ...
                foreach (DataGridViewRow dr in dgvSalesReturn.Rows)
                {
                    if (dr.Cells["productId"].Value != null && dr.Cells["productId"].Value.ToString() != string.Empty)
                    {
                        if (dr.Cells["dgvTextAmount1"].Value != null && dr.Cells["dgvTextAmount1"].Value.ToString() != string.Empty)
                        {
                            ...
                            DecTotalAmount = Math.Round(DecTotalAmount, 4);
                    ...
                    if (dgvSalesReturn.Rows.Count > 1)
                    {
                        foreach (DataGridViewRow dgvRow in dgvSalesReturn.Rows)
                        {
                            ...
                            if (dgvRow.Cells["productId"].Value != null)
                            {
                                ...
                                {
                                    decProductId = dgvRow.Cells["productId"].Value.ToString();
                    ...
                    if (dgvSalesReturn.Rows[e.RowIndex].Cells["salesDetailsId"].Value != null && dgvSalesReturn.Rows[e.RowIndex].Cells["salesDetailsId"].Value.ToString() != string.Empty)
                    {
                        if (decimal.Parse(dgvSalesReturn.Rows[e.RowIndex].Cells["salesDetailsId"].Value.ToString()) > 0)
                        {
                            if (dgvSalesReturn.Rows[e.RowIndex].Cells["dgvTextQty"].Value != null && dgvSalesReturn.Rows[e.RowIndex].Cells["dgvTextQty"].Value.ToString() != string.Empty)
                            {
                                ...
                                {
                                    dgvSalesReturn.Rows[e.RowIndex].Cells["dgvTextQty"].Value = Math.Round(Convert.ToDecimal(dtblSalesReturnGrideFill.Rows[e.RowIndex]["qty"].ToString()));
                                }
                            }
                        }
                    }
