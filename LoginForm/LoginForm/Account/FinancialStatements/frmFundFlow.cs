...
namespace LoginForm
{
    public partial class frmFundFlow : Form
    {
        ...
        public System.Data.DataSet GetdataSet()
        {
            ...
            System.Data.DataSet dsFundFlow = new System.Data.DataSet();
            try
            {
        ...
        public void Print(DateTime fromDate, DateTime toDate)
        {
            try
            {
                //System.Data.DataSet dsFundFlow = GetdataSet();
        ...
        public void Clear()
        {
            ...
            {
                isFormLoad = true;
                dtpFundFlowFromDate.MinDate = Convert.ToDateTime(Utils.getManagement().FinancialYear.fromDate);
                dtpFundFlowFromDate.MaxDate = Convert.ToDateTime(Utils.getManagement().FinancialYear.toDate);
                dtpFundFlowFromDate.Value = Convert.ToDateTime(Utils.getManagement().FinancialYear.fromDate);
                dtpFundFlowToDate.MinDate = Convert.ToDateTime(Utils.getManagement().FinancialYear.fromDate);
                dtpFundFlowToDate.MaxDate = Convert.ToDateTime(Utils.getManagement().FinancialYear.toDate);
                dtpFundFlowToDate.Value = Convert.ToDateTime(Utils.getManagement().FinancialYear.toDate);
            ...
            try
            {
                if (!isFormLoad)
                {
                    ...
                    if (txtFundFlowFromDate.Text == string.Empty)
                        txtFundFlowFromDate.Text = Utils.getManagement().FinancialYear.fromDate.Value.ToString("dd-MMM-yyyy");
                    objValidation.DateValidationFunction(txtFundflowToDate);
                    if (txtFundflowToDate.Text == string.Empty)
                        txtFundflowToDate.Text = Utils.getManagement().FinancialYear.toDate.Value.ToString("dd-MMM-yyyy");
                    //-------------------------------------First gridfill-------------------------------------//
