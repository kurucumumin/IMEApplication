...
namespace LoginForm
{
    public partial class frmCashFlow : Form
    {
        ...
        public void Clear()
        {
            try
            {
                txtFromDate.Text = Utils.getManagement().FinancialYear.fromDate.Value.ToString();
                txttoDate.Text = Utils.getManagement().FinancialYear.toDate.Value.ToString();
                GridFill();
            }
            catch (Exception ex)
            {
        ...
        {
            System.Data.DataSet dsCashflow = new System.Data.DataSet();
            try
            {
                FinancialStatementSP spFinancial = new FinancialStatementSP();
        ...
        public void Print(DateTime fromDate, DateTime toDate)
        {
            try
            {
                System.Data.DataSet dsCashflow = GetDataSet();
