...
namespace LoginForm
{
    public partial class frmProfitAndLoss : Form
    {
        ...
        {
            System.Data.DataSet dsProfit = new System.Data.DataSet();
            try
            {
                FinancialStatementSP spfinancial = new FinancialStatementSP();
        ...
        private void frmProfitAndLoss_Load(object sender, EventArgs e)
        {
            ...
            {
                isFormLoad = true;
                dtpContraVoucherDate.MinDate = Convert.ToDateTime(Utils.getManagement().FinancialYear.fromDate);
                dtpContraVoucherDate.MaxDate = Convert.ToDateTime(Utils.getManagement().FinancialYear.toDate);
                dtpContraVoucherDate.Value = Convert.ToDateTime(Utils.getManagement().FinancialYear.fromDate);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    dtpTodate.Value = Utils.getManagement().FinancialYear.toDate.Value;
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtFromDate.Text = Convert.ToDateTime(Utils.getManagement().FinancialYear.fromDate.Value).ToString();
                txtToDate.Text = Convert.ToDateTime(dtpTodate.Value).ToString();
                Gridfill();
            }
            catch (Exception ex)
            {
