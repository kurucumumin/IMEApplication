...
namespace LoginForm
{
    public partial class frmAgeingReport : Form
    {
        ...
        /// </summary>
        /// <returns></returns>
        public System.Data.DataSet getdataset1()
        {
            System.Data.DataSet dsFundFlow = new System.Data.DataSet();
            try
            {
        ...
        public void InitialDateSettings()
        {
            ...
            try
            {
                dtpAgeingDate.Value = Utils.getManagement().FinancialYear.toDate.Value;
                dtpAgeingDate.MinDate = Utils.getManagement().FinancialYear.fromDate.Value;
                dtpAgeingDate.MaxDate = Utils.getManagement().FinancialYear.toDate.Value;
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        Print1(Utils.getManagement().FinancialYear.toDate.Value);
                    }
                }
            }
            catch (Exception ex)
