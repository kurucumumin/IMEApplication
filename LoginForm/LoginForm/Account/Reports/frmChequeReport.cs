    ...
    public partial class frmChequeReport : Form
    {
        ...
        public void ChequeReportFillGrid()
        {
            try
            {
                ...
                string strTotalAmount = Math.Round(decTotalAmount, 4).ToString();
                ...
                dtbl = spPDCPayable.ChequeReportGridFill(dtpIssueFromDate.Value, dtpIssueToDate.Value, dtpChequeFromDate.Value, dtpChequeToDate.Value, isIssued, decParty, txtChequeNo.Text);
        ...
        public void Clear()
        {
            ...
            try
            {
                ...
                dtpChequeFromDate.Value = Utils.getManagement().FinancialYear.fromDate.Value;
                dtpChequeToDate.Value = IME.CurrentDate().FirstOrDefault().Value;
                dtpIssueFromDate.Value = Utils.getManagement().FinancialYear.fromDate.Value;
                dtpIssueToDate.Value = IME.CurrentDate().FirstOrDefault().Value;
        ...
        public System.Data.DataSet GetDataSet()
        {
            ...
            System.Data.DataSet dsChequeReport = new System.Data.DataSet();
        ...
        public void Print()
        {
            try
            {
                //System.Data.DataSet dsChequeReport = GetDataSet();
            ...
            try
            {
                if (txtIssueFromDate.Text != string.Empty && txtIssueToDate.Text != string.Empty)
                {
                    if (Convert.ToDateTime(txtIssueToDate.Text) < Convert.ToDateTime(txtIssueFromDate.Text))
                    {
                        ...
                        txtIssueToDate.Text = IME.CurrentDate().FirstOrDefault().Value.ToString("dd-MMM-yyyy");
                        txtIssueFromDate.Text = Utils.getManagement().FinancialYear.fromDate.Value.ToString("dd-MMM-yyyy");
                        DateTime dt;
                ...
                {
                    txtIssueFromDate.Text = Utils.getManagement().FinancialYear.fromDate.Value.ToString();
                    txtIssueToDate.Text = IME.CurrentDate().FirstOrDefault().Value.ToString();
                    DateTime dt;
                    DateTime.TryParse(txtIssueToDate.Text, out dt);
                    dtpIssueToDate.Value = dt;
                    dtpIssueFromDate.Value = dt;
                ...
                if (txtChequeFromDate.Text != string.Empty && txtChequeToDate.Text != string.Empty)
                {
                    if (Convert.ToDateTime(txtChequeToDate.Text) < Convert.ToDateTime(txtChequeFromDate.Text))
                    {
                        ...
                        txtChequeToDate.Text = IME.CurrentDate().FirstOrDefault().Value.ToString("dd-MMM-yyyy");
                        txtChequeFromDate.Text = Utils.getManagement().FinancialYear.fromDate.Value.ToString("dd-MMM-yyyy");
                        DateTime dt;
                        DateTime.TryParse(txtIssueToDate.Text, out dt);
                ...
                {
                    txtChequeFromDate.Text = IME.CurrentDate().FirstOrDefault().Value.ToString();
                    txtChequeToDate.Text = Utils.getManagement().FinancialYear.fromDate.Value.ToString();
                    DateTime dt;
