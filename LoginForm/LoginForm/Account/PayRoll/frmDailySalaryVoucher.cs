...
namespace LoginForm
{
    public partial class frmDailySalaryVoucher : Form
    {
        ...
        public void fillFunction()
        {
            ...
            {
                DailySalaryVoucherMasterSP SpMaster = new DailySalaryVoucherMasterSP();
                DailySalaryVoucherMaster InfoMaster = new DailySalaryVoucherMaster();
                VoucherTypeSP spVoucherType = new VoucherTypeSP();
                ...
                lblShowTotelamount.Text = Math.Round(Convert.ToDecimal(InfoMaster.totalAmount.Value.ToString("0.00000")), 4).ToString();
                txtNarration.Text = InfoMaster.narration;
                decDailySuffixPrefixId = Convert.ToDecimal(InfoMaster.suffixPrefixId);
                decDailyVoucherTypeId = Convert.ToDecimal(InfoMaster.voucherTypeId);
        ...
        public void TotelWageAmount()
        {
            try
            {
                ...
                lblShowTotelamount.Text = Math.Round(Convert.ToDecimal(decPayTotal.ToString("0.00000")), 4).ToString();
        ...
        public void LedgerPosting(decimal decid)
        {
            ...
            try
            {
                ...
                infoLedgerPosting.date = IME.CurrentDate().FirstOrDefault().Value;
        ...
        public void LedgerUpdate()
        {
            ...
            try
            {
                ...
                LedgerPosting infoLedgerPosting = new LedgerPosting();
                DataTable dtbl = new DataTable();
                dtbl = spLedgerPosting.GetLedgerPostingIds(strVoucherNo, Convert.ToInt32(decDailyVoucherTypeId));
                int ini = 0;
        ...
        public void SaveFunction()
        {
            try
            {
                ...
                DailySalaryVoucherMaster infoMaster = new DailySalaryVoucherMaster();
                DailySalaryVoucherMasterSP spMaster = new DailySalaryVoucherMasterSP();
                DailySalaryVoucherDetail infoDetails = new DailySalaryVoucherDetail();
                DailySalaryVoucherDetailsSP spDetails = new DailySalaryVoucherDetailsSP();
                ...
                else
                {
                    ...
                    infoMaster.financialYearId = Utils.getManagement().FinancialYear.financialYearId;
                    ...
                    if (inval >= 0)
                    {
                        ...
                        infoDetails.dailySalaryVoucherMasterId = decMasterId;
        ...
        public void EditFunction()
        {
            try
            {
                ...
                infoMaster.dailySalaryVoucherMasterId = decMasterIdforEdit;
                ...
                for (int i = 0; i < inRowCount; i++)
                {
                    ...
                    if (dgvDailySalaryVoucher.Rows[i].Cells["cmbStatus"].Value.ToString() == "paid" && dgvDailySalaryVoucher.Rows[i].Cells["dgvtxtDailySalaryVocherMasterId"].Value.ToString() == string.Empty)
                    {
                        infoDetails.dailySalaryVoucherMasterId = decMasterIdforEdit;
                        spDetails.DailySalaryVoucherDetailsAdd(infoDetails);
                        //spMaster.DailySalaryVoucherMasterEdit(infoMaster);
                        LedgerUpdate();
        ...
        public void Clear()
        {
            ...
            try
            {
                ...
                if (isEditmode == false)
                {
                    ...
                    dtpSalaryDate.Value = IME.CurrentDate().FirstOrDefault().Value;
                    dtpSalaryDate.MinDate = Utils.getManagement().FinancialYear.fromDate.Value;
                    dtpSalaryDate.MaxDate = Utils.getManagement().FinancialYear.toDate.Value;
                }

                dtpDate.Value = IME.CurrentDate().FirstOrDefault().Value;
                dtpDate.MinDate = Utils.getManagement().FinancialYear.fromDate.Value;
                dtpDate.MaxDate = Utils.getManagement().FinancialYear.toDate.Value;
        ...
        private void dtpSalaryDate_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DailySalaryVoucherDetailsGridfill(isEditmode);
                lblShowTotelamount.Text = Math.Round(Convert.ToDecimal(0.00000), 4).ToString();
                txtNarration.Text = string.Empty;
            }
            catch (Exception ex)
            {
        ...
        private void txtSalaryDate_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    txtSalaryDate.Text = IME.CurrentDate().FirstOrDefault().Value.ToString("dd-MMM-yyyy");
                }
        ...
        private void txtSalaryDate_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                lblShowTotelamount.Text = Math.Round(Convert.ToDecimal("0.00000"), 4).ToString(); //"0.00000";
                txtNarration.Text = string.Empty;
        ...
        private void txtDate_Leave(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!isValidate)
                {
                    txtDate.Text = IME.CurrentDate().FirstOrDefault().Value.ToString("dd-MMM-yyyy");
                }
                //---for change date in Date time picker----//
