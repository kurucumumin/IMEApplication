...
namespace LoginForm
{
    ...
    public partial class frmLedgerPopup : Form
    {
        ...
        FormQuotationMain frmsalesQuotationObj = null;
       ...
       // frmPOS frmPOSObj = null;
        ...
        /// <param name="decId"></param>
        /// <param name="strComboType"></param>
        public void CallFromPurchaseOrder(PurchaseOrderMain frmPurchaseOrder, decimal decId, string strComboType) //PopUp
        {
            try
            {
                strComboTypes = strComboType;
