                ...
                if (cmbVoucherType.SelectedIndex != -1)
                {
                    switch (VoucherType)
                    {
                        ...
                        case "Purchase Order":
                            ...
                            NewPurchaseOrder frmPurchaseOrderObj = new NewPurchaseOrder();
                            NewPurchaseOrder OpenPurchaseOrder = Application.OpenForms["frmPurchaseOrder"] as NewPurchaseOrder;
