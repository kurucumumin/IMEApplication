    ...
    public partial class frmPDCPayableRegister : Form
    {
        ...
        public void GridSearchRegister()
        {
            try
            {
                ...
                dtbl = new PDCPayableMasterSP().PDCpayableRegisterSearch(Convert.ToDateTime(dtpfromDate.Value.ToString()), Convert.ToDateTime(dtpTodate.Value.ToString()), txtvoucherNo.Text.Trim(), cmbAccountLedger.Text.ToString());
