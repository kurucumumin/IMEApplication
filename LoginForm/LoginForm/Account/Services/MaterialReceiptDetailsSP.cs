...
{
    class MaterialReceiptDetailsSP
    {
        public DataTable MaterialReceiptDetailsViewByMaterialReceiptMasterIdWithRemainingByNotInCurrPI(decimal decMaterialReceiptMasterId, decimal decPurchaseMasterId, decimal decVoucherTypeId)
        {
            ...
            try
            {
                var adaptor = db.MaterialReceiptDetailsViewByMaterialReceiptMasterIdWithRemainingByNotInCurrPI(decMaterialReceiptMasterId.ToString(), decPurchaseMasterId.ToString(),decVoucherTypeId);
