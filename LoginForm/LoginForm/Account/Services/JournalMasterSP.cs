...
namespace LoginForm.Account.Services
{
    class JournalMasterSP
    {
        ...
        public DataTable JournalReportSearchLedgerId(string strFromDate, string strToDate, decimal decLedgerId)
        {
            IMEEntities IME = new IMEEntities();
            DataTable dtbl = new DataTable();
            dtbl.Columns.Add("SlNo", typeof(decimal));
        ...
        public DataTable JournalReportSearch(string strFromDate, string strToDate)
        {
            IMEEntities IME = new IMEEntities();
            DataTable dtbl = new DataTable();
            dtbl.Columns.Add("SlNo", typeof(decimal));
